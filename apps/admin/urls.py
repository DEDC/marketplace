...
# app admin
from .views import (
    vAdmin, vLogin, vLogout, CreateProduct, ListProducts, ListSales, ListShipping, UpdateProduct, ListUsers,
    CreateCategory
)
...
urlpatterns = [
    ...
    path('registrar/categoria', CreateCategory.as_view(), name = 'create_category'),
